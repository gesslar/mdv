...
/** @typedef {.CallbackResponse} CallbackResponse */
/** @typedef {.CompiledMode} CompiledMode */
...
/** @typedef {.Mode} Mode */
/** @typedef {.ModeCallback} ModeCallback */
...
/**
@typedef {.CallbackResponse} CallbackResponse
@typedef {.CompilerExt} CompilerExt
*/
...
@typedef {.HLJSPlugin} HLJSPlugin
@typedef {.CompiledLanguage} CompiledLanguage
*/
...
@typedef {.Mode} Mode
@typedef {.CompiledMode} CompiledMode
@typedef {.CompiledScope} CompiledScope
@typedef {.Language} Language
@typedef {.HLJSApi} HLJSApi
@typedef {.HLJSPlugin} HLJSPlugin
@typedef {.PluginEvent} PluginEvent
@typedef {.HLJSOptions} HLJSOptions
@typedef {.LanguageFn} LanguageFn
@typedef {.HighlightedHTMLElement} HighlightedHTMLElement
@typedef {.BeforeHighlightContext} BeforeHighlightContext
@typedef {.MatchType} MatchType
@typedef {.KeywordData} KeywordData
@typedef {.EnhancedMatch} EnhancedMatch
@typedef {.AnnotatedError} AnnotatedError
@typedef {.AutoHighlightResult} AutoHighlightResult
@typedef {.HighlightOptions} HighlightOptions
@typedef {.HighlightResult} HighlightResult
*/
